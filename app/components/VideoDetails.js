...
export default function VideoDetails({ id }) {
  ...
  return (
    <div className="flex justify-center h-[calc(100% - 56px)] dark:bg-black bg-white">
      <div className="w-full flex flex-col lg:flex-row max-w-[1280px] ">
        <div className="flex flex-col  lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
          ...
          <div className="text-sm dark:text-white text-black font-bold mt-4 line-clamp-2 md:text-xl">
            {video?.title}
          </div>
          <div className="flex flex-col md:flex-row mt-4 justify-between">
            ...
            <div className="flex darK:text-white text-black mt-4 md:mt-0">
